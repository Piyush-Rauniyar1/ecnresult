...
async function main() {
    console.log('======================================');
    console.log('Fixing additional constituencies');
    console.log('======================================');

    const constituencies = [
        { name: 'Makwanpur-1', url: 'https://election.ekantipur.com/pradesh-3/district-makwanpur/constituency-1?lng=eng' },
        { name: 'Makwanpur-2', url: 'https://election.ekantipur.com/pradesh-3/district-makwanpur/constituency-2?lng=eng' },
        { name: 'Sindhupalchok-2', url: 'https://election.ekantipur.com/pradesh-3/district-sindhupalchowk/constituency-2?lng=eng' },
        { name: 'Gorkha-2', url: 'https://election.ekantipur.com/pradesh-4/district-gorkha/constituency-2?lng=eng' },
        { name: 'Nawalparasi East-1', url: 'https://election.ekantipur.com/pradesh-4/district-nawalparasieast/constituency-1?lng=eng' },
        { name: 'Nawalparasi East-2', url: 'https://election.ekantipur.com/pradesh-4/district-nawalparasieast/constituency-2?lng=eng' },
        { name: 'Eastern Rukum-1', url: 'https://election.ekantipur.com/pradesh-5/district-rukumeast/constituency-1?lng=eng' },
        { name: 'Rukum West-1', url: 'https://election.ekantipur.com/pradesh-6/district-rukumwest/constituency-1?lng=eng' },
    ];
