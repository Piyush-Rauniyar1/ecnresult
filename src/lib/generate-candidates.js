...
// We will add candidates for Kathmandu-1 (constituency_id = 91)
// And Sunsari-1 (constituency_id = 21) based on the auto-generated IDs from our previous script.
...
fs.writeFileSync('supabase/candidates_seed.sql', sql);
console.log('Successfully generated supabase/candidates_seed.sql with candidate entries.');
